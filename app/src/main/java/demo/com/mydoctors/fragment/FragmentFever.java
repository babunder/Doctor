...
public class FragmentFever extends Fragment implements View.OnClickListener {
    ...
    int[] sampleImages = {R.drawable.fever, R.drawable.fever1, R.drawable.fever2, R.drawable.fever3};
    ...
    private void initView(View view) {
        ...
        tv_info.setText(getString(R.string.fever_info));
    ...
    public void onClick(View v) {
        ...
        switch (v.getId()) {
            case R.id.txtSubmit:
                ...
                try {
                    if (((firstValue.contentEquals("Yes") || firstValue.contentEquals("हाँ") || firstValue.contentEquals("होय")) ||
                        ...
                        showAlert1();
                        //     ((ActivityMain) getActivity()).replaceFragment(new FragmentDoDontFever());
            ...
            case R.id.ivGallery:
                ...
                intent.putExtra(Constants.FRAGMENT_SCREEN, Constants.FRAGMENT_SCREEN_FEVER);
                startActivity(intent);
                break;

            case R.id.ivVideo:
                Intent intentVideo = new Intent(getContext(), VideoListActivity.class);
                intentVideo.putExtra(Constants.FRAGMENT_SCREEN, Constants.FRAGMENT_SCREEN_FEVER);
