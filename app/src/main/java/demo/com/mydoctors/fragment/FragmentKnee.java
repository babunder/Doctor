...
public class FragmentKnee extends Fragment implements View.OnClickListener {
    ...
    int[] sampleImages = {R.drawable.knee, R.drawable.knee1, R.drawable.knee2, R.drawable.knee3};

    @Nullable
    @Override
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        View view = inflater.inflate(R.layout.fragment_knee, container, false);
        initView(view);
        return view;
    }
    ...
    private void initView(View view) {
        ...
        //((AppCompatActivity) getActivity()).getSupportActionBar().setTitle("Knee ache");

        TextView tvTitle = view.findViewById(R.id.tvTitle);
        tvTitle.setText("Knee ache");
        ...
        tv_info.setText(getString(R.string.Knee_info));
    ...
    public void onClick(View v) {
        ...
        switch (v.getId()) {
            case R.id.txtSubmit:
                ...
                try {
                    if (((firstValue.contentEquals("Yes") || firstValue.contentEquals("हाँ") || firstValue.contentEquals("होय")) ||
                        ...
                        showAlert1();
                        //  ((ActivityMain) getActivity()).replaceFragment(new FragmentDoDontKnee());
            ...
            case R.id.ivGallery:
                ...
                intent.putExtra(Constants.FRAGMENT_SCREEN, Constants.FRAGMENT_SCREEN_KNEE_ACHE);
                startActivity(intent);
                break;

            case R.id.ivVideo:
                Intent intentVideo = new Intent(getContext(), VideoListActivity.class);
                intentVideo.putExtra(Constants.FRAGMENT_SCREEN, Constants.FRAGMENT_SCREEN_KNEE_ACHE);
